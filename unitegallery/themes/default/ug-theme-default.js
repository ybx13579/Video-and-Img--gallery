...
function UGTheme_default(){
	...
	var g_options = {
			...
			theme_text_align: "center",				//left, center, right - the align of the text in the textpanel
			theme_text_type: "description",				//title, description - text that will be shown on the text panel, title or description
