		...
		g_arrItems = [];
		 ...
		 for(var i=0;i<arrChildren.length;i++){
			 ...
			 if(objItem.objThumbImage){
				 ...
				 objItem.objThumbImage.removeAttr("data-ss_title", "");
...
function UGTextPanel(){
	...
	var g_options = {
			textpanel_align:"bottom",					//(top , bottom), textpanel align according the parent                      文本面板
			...
			textpanel_ss_title: true,
			textpanel_enable_description: true,			//enable the description text
			textpanel_enable_bg: true,					//enable the textpanel background
			textpanel_bg_color:"#000000",				//textpanel background color
			textpanel_bg_opacity: 0.3,					//textpanel background opacity
	...
	this.appendHTML = function(objParent){
		...
		if (g_options.textpanel_ss_title == true)
		    html += "<div class='ss_title'></div>";
	...
	function setCss(){
	    ...
	    //标题
		if (g_options.textpanel_enable_title == true) {
		    g_objTitle = g_objTextWrapper.children(".ss_title");
		    var objCssSSTitle = {};

		    if (g_options.textpanel_title_color !== null)
		        objCssSSTitle["color"] = g_options.textpanel_title_color;

		    if (g_options.textpanel_title_font_family !== null)
		        objCssSSTitle["font-family"] = g_options.textpanel_title_font_family;

		    if (g_options.textpanel_title_text_align !== null)
		        objCssSSTitle["text-align"] = g_options.textpanel_title_text_align;

		    if (g_options.textpanel_title_font_size !== null)
		        objCssSSTitle["font-size"] = g_options.textpanel_title_font_size + "px";

		    if (g_options.textpanel_title_bold !== null) {

		        if (g_options.textpanel_title_bold === true)
		            objCssSSTitle["font-weight"] = "bold";
		        else
		            objCssSSTitle["font-weight"] = "normal";

		    }

		    //set additional css
		    if (g_options.textpanel_css_title)
		        objCssSSTitle = jQuery.extend(objCssSSTitle, g_options.textpanel_css_title);

		    g_objTitle.css(objCssSSTitle);
		}
