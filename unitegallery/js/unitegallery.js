...
function UniteGalleryMain(){
	...
	var g_options = {				
			...
			gallery_height:570,							//gallery height            500
...
function UGSlider(){
	...
	var g_options = {
		  ...
		  slider_transition_speed:100,				 	//transition duration of slide change
...
function UGTextPanel(){
	...
	var g_options = {
			textpanel_align:"bottom",					//(top , bottom), textpanel align according the parent                      ÎÄ±¾Ãæ°å
	...
	this.appendHTML = function(objParent){
		...
		if(g_options.textpanel_enable_description == true)
		    html += "<div class='ug-textpanel-description' style='top:40px;'></div><div class='ss_title'></div>";
